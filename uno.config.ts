...
export default defineConfig({
  ...
  shortcuts: {
    ...
    "cc-input":
      "w-full px-4 py-3 bg-transparent border-none outline-none text-base placeholder-gray-400",
    "cc-item":
    ...
    "cc-kbd":
      "px-1.5 py-0.5 text-xs font-mono rounded border bg-gray-100 dark:bg-gray-800 border-gray-200 dark:border-gray-700",
